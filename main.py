...
class Product(db.Model):
    ...
    img_url_one: Mapped[str] = mapped_column(String, nullable=False)
    img_url_two: Mapped[str] = mapped_column(String, nullable=True)
    img_url_three: Mapped[str] = mapped_column(String, nullable=True)
